...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.NominalTimeSeg1 = 44;
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.NominalSyncJumpWidth = 14;
  hfdcan2.Init.NominalTimeSeg1 = 55;
  hfdcan2.Init.NominalTimeSeg2 = 19;
...
void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.NominalSyncJumpWidth = 15;
  hfdcan3.Init.NominalTimeSeg1 = 44;
  hfdcan3.Init.NominalTimeSeg2 = 15;
